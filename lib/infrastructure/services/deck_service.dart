...
class DeckService extends BaseService {
  ...
  Future<Response> getPopularDecks() async => await get(
      path: "flashcards/api/v1/decks/all",
      params: {"limit": "10", "field": "playCount", "sort": "DESC"});

  Future<Response> getEscapeDecks() async => await get(
      path: "flashcards/api/v1/decks/all",
      params: {"limit": "4", "field": "playCount", "sort": "ASC"});
